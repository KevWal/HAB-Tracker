...
import com.brejza.matt.habmodem.util.JSONUtils;
...
import static com.brejza.matt.habmodem.util.JSONUtils.urlEncodePath;
...
public class Database {
  ...
  /**
   * Runs a named view on the database, but will return the body rather than parsing
   * This will run a view and apply any filtering that is requested (reverse, startkey, etc).
   *
   * @param view
   * @return
  ...
  public InputStream view_dont_parse(View view) {
      ...
      return session.get_stream(url, view.getQueryString());
  }

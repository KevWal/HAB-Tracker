...
public class fsk_receiver implements StringRxEvent {
    ...
    public int fft_update_freq = 500; //KEW Originally 2000, but with 3,000 samples being passed at any one time, this isn't slowing fft_update
 ...
 //       grtty.clearMarkers();
	...
	public String processBlock (double[] samples, int baud)
	{
		...
		{
			// System.out.println("KEW Call calculate_FFT. Samples_since_fft: " + samples_since_fft + " Samples: " + _samples.length + ". ");
			calcuate_FFT();
			samples_since_fft = 0;
		}
